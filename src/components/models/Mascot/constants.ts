...
export const ANIMATIONS = {
  ...
  IdleBashful: "IdleBashful",
  Pray: "Armature.001|mixamo.com|Layer0",
...
export const ANIMATION_CONFIG = {
  ...
  [ANIMATIONS.IdleBashful]: { type: "emote", loop: true, duration: 0.4 },
  [ANIMATIONS.Pray]: { type: "emote", loop: false, duration: 0.2 },
