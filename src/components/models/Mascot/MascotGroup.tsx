...
export interface MascotGroupRef {
  openPortal: (cfg?: PortalConfig) => void;
  closePortal: () => void;
  hide: () => void;
  show: () => void;
  toggle: () => void;
...
export const MascotGroup = forwardRef<MascotGroupRef, { gltf: any; defaultVisibile: boolean }>(
  ({ gltf, defaultVisibile }, ref) => {
    const { nodes } = gltf;
    ...
    useImperativeHandle(ref, () => ({
      ...
      openPortal: (cfg?: PortalConfig) => {
        ...
        const plane = new THREE.Plane().setFromNormalAndCoplanarPoint(
          normalWorld,
          new THREE.Vector3(...merged.position)
        );
