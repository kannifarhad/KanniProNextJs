...
interface IpadProps extends React.ComponentProps<'group'> {
  focused?: boolean;
}

export function Ipad({ focused = false, ...props }: IpadProps) {
    ...
    <group ref={group} {...props} dispose={null}>
      <group scale={0.5}>
        <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            geometry={(nodes.iPad_Pro_2020_Body_0 as THREE.Mesh).geometry}
          ...
          />
          <mesh
            geometry={(nodes.iPad_Pro_2020_bezel_0 as THREE.Mesh).geometry}
            material={materials.bezel}
          />
          <mesh
            geometry={(nodes.camera_module_Body_0 as THREE.Mesh).geometry}
            material={materials.Body}
          />
          <mesh
            geometry={(nodes.camera_module_glass_0 as THREE.Mesh).geometry}
            material={materials.glass}
          />
          <mesh
            geometry={(nodes.camera_module2_camera2_0 as THREE.Mesh).geometry}
          ...
          />
          <mesh
            geometry={(nodes.camera1_camera1_0 as THREE.Mesh).geometry}
            material={materials.camera1}
          />
          <mesh
            geometry={(nodes["camera1_camera1(2)_0"] as THREE.Mesh).geometry}
            material={materials.camera12}
          />
          <mesh
            geometry={(nodes.camera2_camera2_0 as THREE.Mesh).geometry}
            material={materials.camera2}
          />
          <mesh
          ...
          />
          <mesh
            geometry={(nodes.camera1001_camera1_0 as THREE.Mesh).geometry}
            material={materials.camera1}
          />
          <mesh
            geometry={(nodes["camera1001_camera1(2)_0"] as THREE.Mesh).geometry}
            material={materials.camera12}
          />
          <mesh
          ...
          />
          <mesh
            geometry={(nodes.camera_module2001_Mic_0 as THREE.Mesh).geometry}
          ...
          />
          <mesh
            geometry={(nodes.Connector__0 as THREE.Mesh).geometry}
          ...
          />
          <mesh
            geometry={(nodes["Front_camera_camera1(2)_0"] as THREE.Mesh).geometry}
            material={materials.camera12}
          />
          <mesh
            geometry={(nodes.Front_camera_glass_0 as THREE.Mesh).geometry}
            material={materials.glass}
          />
          <mesh
            geometry={(nodes.Speakers_Mic_0 as THREE.Mesh).geometry}
            material={materials.material}
          />
          <mesh
            geometry={(nodes.Speakers_Body_0 as THREE.Mesh).geometry}
            material={materials.Body}
          />
          <mesh
            geometry={(nodes.power_button_Body_0 as THREE.Mesh).geometry}
            material={materials.Body}
          />
          <mesh
            geometry={(nodes.Volume_button_Body_0 as THREE.Mesh).geometry}
            material={materials.Body}
          />
          <group
